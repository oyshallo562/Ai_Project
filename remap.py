...
# Example usage
txt_directory = 'A:/dataset_yolo/images/train/labels'  # Update with your path
images_directory = 'A:/dataset_yolo/images/train/images'  # Path to the corresponding images
